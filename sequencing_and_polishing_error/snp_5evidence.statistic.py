    ...
    with open(sys.argv[1], 'r') as fh:
        ...
        for i in fh:
            ...
            if i.startswith("#"):
                ...
                continue
            SNP = Record(i)
            # case 1, all good, this definitely is a heterogyous site
            if SNP.patref == SNP.mummer and SNP.mummer == SNP.gatk :
                tag.write(i + "\tNo_doubt\tTrue\n")
                continue
            # case 2, this is true SNP site but it show indel in Mummer result, which
            # means this is assembly error.
            if SNP.patref == ".":
                tag.write(i + "\tFalse_Indel_True_Snp\tTrue\n")
                continue
            ...
            if SNP.note1 == "GR" and SNP.note2 == "LOW":
                tag.write(i + "\thard2id\t-\n")
                continue
